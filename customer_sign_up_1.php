  ...
  <head>
	...
	<section class="ftco-section">
		<div class="container">
			...
			<form action="customer_sign_up_2.php" class="signin-form" method="post" enctype="multipart/form-data">

                <div class="form-group mb-3">
                  <label class="label" for="">UserName</label>
                  <input type="text" name="cus_name" class="form-control" placeholder="Enter Your User Name" required>
                </div>

			    <div class="form-group mb-3">
			      	<label class="label" for="">Add Your E-Mail Address</label>
			      	<input type="text" name="cus_id" class="form-control" placeholder="Ex: admin@gmail.com " required>
			    </div>
