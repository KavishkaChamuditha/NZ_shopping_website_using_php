...
<form class="product-margin" action="delete_product_2.php" method="post" enctype="multipart/form-data">
    <div class="form-group">
      <label for="name" class="text-dark">Enter The Record ID You Want To Delete</label>
