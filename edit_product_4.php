      ...
      if($_REQUEST['status']=="pass"){
        ...
        ?>
            <div class="alert alert-success alert-dismissible fade show product-alert" role="alert">
              ...
              <strong>Awesome </strong> Editing a new record was successfully done.
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
              <br />
              <a href="add_product_1.php" class="btn btn-success my-3">Edit Another Record</a>
            </div>
        <?php
      }
      else{
