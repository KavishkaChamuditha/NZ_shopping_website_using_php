      ...
      if($_REQUEST['status']=="pass"){
        ...
        ?>
            <div class="alert alert-success alert-dismissible fade show product-alert" role="alert">
              ...
              <strong>Great </strong> Deleting record was successfully done.
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
              <br />
              <a href="delete_product_1.php" class="btn btn-success my-3">Delete Another Record</a>
            </div>
        <?php
      }
      else{
        ...
        ?>
            <div class="alert alert-danger alert-dismissible fade show product-alert" role="alert">
              ...
              <strong>Sorry</strong> Deleting record failed. Pleas try again.
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
              <br />
